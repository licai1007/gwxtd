         ...
         <td align="center">
           <form action="AdminServlet" method="post" name="myform">
             <table>
               <tr>
                 <td>商品名称:</td>
                 <td><input name="gname" size="30" value="<%= %>"/></td>
               </tr>
               <tr>
                 <td>商品价格:</td>
                 <td><input name="gprice" size="30" value="<%= %>"/></td>
               </tr>
               <tr>
                 <td>商品数量:</td>
                 <td><input name="gamount" size="30" value="<%= %>"/></td>
               </tr>
               <tr>
                 <td>商品类别:</td>
                 <td><input name="gclass" size="30" value="<%= %>"/></td>
               </tr>
               <tr>
                 <td>上架日期:</td>
                 <td><input name="gdate" size="30" value="<%= %>"/></td>
               </tr>
               <tr>
                 <td>图片URL:</td>
                 <td><input name="gurl" size="30" value="<%= %>"/></td>
               </tr>
               <tr>
                 <td>商品说明:</td>
               </tr>
               <tr>
                 <td colspan="2">
                   <textarea cols="60" rows="6" name="gintro"></textarea>
                 </td>
               </tr>
               <tr>
                 <td>商品简介:</td>
               ...
               <tr>
                 <td colspan="2">
                   <textarea cols="60" rows="6" name="gbrief"></textarea>
                 </td>
               </tr>
               <tr align="center">
                 <td colspan="2">
